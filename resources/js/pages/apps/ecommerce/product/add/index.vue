  ...
  <div>
    <div class="d-flex flex-wrap justify-space-between gap-4 mb-6">
      <div class="d-flex flex-column justify-center">
        <h4 class="text-h4">Add a new product</h4>
    ...
    <VRow>
      <VCol md="8">
        ...
        <VCard class="mb-6" title="Product Information">
          <VCardText>
            <VRow>
              <VCol cols="12">
                <VTextField label="Product Name" placeholder="iPhone 14" />
              </VCol>
              <VCol cols="12" md="6">
                <VTextField label="SKU" placeholder="FXSK123U" />
              </VCol>
              <VCol cols="12" md="6">
                <VTextField label="Barcode" placeholder="0123-4567" />
              </VCol>
              <VCol>
                <VLabel class="mb-1"> Description (Optional) </VLabel>
                <TiptapEditor v-model="content" class="border rounded" />
              </VCol>
            </VRow>
          </VCardText>
        </VCard>
              ...
              <div class="w-full h-auto relative">
                <div ref="dropZoneRef" class="cursor-pointer" @click="() => open()">
                  ...
                  >
                    ...
                    <VBtn variant="outlined"> Browse Images </VBtn>
                  </div>
        ...
        <VCard title="Variants" class="mb-6">
          <VCardText>
            ...
            <VBtn class="mt-6" @click="optionCounter++"> Add another option </VBtn>
          </VCardText>
        </VCard>
        ...
        <VCard title="Inventory" class="inventory-card">
          <VCardText>
            <VRow>
              ...
              <VDivider :vertical="$vuetify.display.mdAndUp ? true : false" inset />

              <VCol cols="12" md="8">
                <VWindow v-model="activeTab" class="w-100" :touch="false">
                  <VWindowItem value="Restock">
                    <div class="d-flex flex-column gap-y-4">
                      <div class="text-body-1 font-weight-medium">Options</div>
                      <div class="d-flex gap-x-4 align-center">
                        <VTextField
                          ...
                          density="compact"
                        />
                        <VBtn prepend-icon="ri-check-line"> Confirm </VBtn>
                      </div>
                      <div class="d-flex flex-column gap-2 text-high-emphasis">
                        <div>Product in stock now: 54</div>
                        <div>Product in transit: 390</div>
                        <div>Last time restocked: 24th June, 2022</div>
                        <div>Total stock over lifetime: 2,430</div>
                      </div>
                    </div>
                  </VWindowItem>
                  ...
                  <VWindowItem value="Global Delivery">
                    <div>
                      <VRadioGroup v-model="deliveryType">
                        ...
                        <VRadio value="Worldwide delivery" class="mb-4 ps-1">
                          <template #label>
                            <div>
                              <div class="text-high-emphasis font-weight-medium mb-1">
                                Worldwide delivery
                        ...
                        <VRadio value="Selected Countries" class="mb-4 ps-1">
                          <template #label>
                            <div>
                              <div class="text-high-emphasis font-weight-medium mb-1">
                                Selected Countries
                  ...
                  <VWindowItem value="Attributes">
                    <div class="mb-2 text-base font-weight-medium">Attributes</div>
                    <div>
                      <VCheckbox
                      ...
                      <VCheckbox v-model="selectedAttrs" value="Expiry Date" class="ps-3">
                        <template #label>
                          <div class="d-flex flex-column mb-1">
                  ...
                  <VWindowItem value="Advanced">
                    <div class="mb-3 text-base font-weight-medium">Advanced</div>
                    <VRow>
      ...
      <VCol md="4" cols="12">
        ...
        <VCard title="Pricing" class="mb-6">
          <VCardText>
            <VTextField label="Base Price" placeholder="iPhone 14" class="mb-6" />
            <VTextField label="Discounted Price" placeholder="$499" class="mb-4" />
        ...
        <VCard title="Organize">
          <VCardText>
            <div class="d-flex flex-column gap-y-4">
              ...
              />
              <VTextField label="Tags" placeholder="Fashion, Trending, Summer" />
            </div>
          </VCardText>
        </VCard>
      </VCol>
