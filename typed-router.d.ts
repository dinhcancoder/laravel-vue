...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'apps-product-add': RouteRecordInfo<'apps-product-add', '/apps/product/add', Record<never, never>, Record<never, never>>,
    'apps-product-edit': RouteRecordInfo<'apps-product-edit', '/apps/product/edit', Record<never, never>, Record<never, never>>,
